...
class MenuScreen(MDScreen):
    """Tela inicial do aplicativo com as opções do menu principal."""

    def __init__(self, **kwargs):
        """Inicializa e desenha a interface da tela de menu."""
        super().__init__(**kwargs)

        layout = BoxLayout(orientation="vertical")

        self.toolbar = MDTopAppBar(
            title=Textos.TITULO_MENU,
            elevation=0,
        )
        ...
        self.btn_carregar = MDFillRoundFlatButton(
            text=Textos.BTN_CARREGAR_PARTIDA,
            size_hint=(None, None),
            size=(dp(240), dp(50)),
            pos_hint={"center_x": 0.5},
            font_size="16sp",
    ...
    def on_enter(self):
        """Atualiza a tela sempre que ela é exibida, habilitando/desabilitando botão de carregar."""
    ...
    def ir_para_selecao(self):
        """Navega para a tela de seleção de jogos."""
        self.manager.current = "select"

    def carregar_jogo(self):
        """Carrega a partida salva no arquivo e transita para a tela do tabuleiro."""
    ...
    def atualizar_icon_tema(self):
        """Atualiza o ícone de tema escuro/claro na AppBar superior."""
        app = MDApp.get_running_app()
