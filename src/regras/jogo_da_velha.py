...
class JogoDaVelha(JogoTabuleiro):
    """
    Implementação das regras específicas para o Jogo da Velha (Tic-Tac-Toe).
    """
    ...
    def validar_jogada(self, origem, destino):
        """Valida se a célula de destino está dentro dos limites e vazia."""
    ...
    def aplicar_jogada(self, origem, destino):
        """Aplica a jogada (marca o X ou O na célula destino)."""
    ...
    def verificar_fim_de_jogo(self):
        """Verifica todas as linhas, colunas e diagonais para determinar se há vencedor ou empate."""
