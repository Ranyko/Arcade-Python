...
class Connect4(JogoTabuleiro):
    """
    Implementação das regras específicas do jogo Lig4 (Connect 4).
    As peças 'caem' para a posição mais baixa possível em uma coluna.
    """
    ...
    def validar_jogada(self, origem, destino):
        """Verifica se a coluna destino escolhida é válida e tem espaço."""
        _, coluna = destino
    ...
    def aplicar_jogada(self, origem, destino):
        """Aplica a jogada, fazendo a peça cair até a linha mais baixa disponível na coluna."""
    ...
    def verificar_fim_de_jogo(self):
        """
        Verifica horizontal, vertical e ambas as diagonais 
        em busca de 4 peças consecutivas.
        """
